  ...
  _createClass(ImageViewer, [{
    ...
    value: function _initZoomSlider() {
      ...
      var _this$_elements = this._elements,
          ...
          minusHandle = _this$_elements.minusHandle,
          plusHandle = _this$_elements.plusHandle; // zoom in zoom out using zoom handle
      ...
      this._events.onZoomMinusClick = (0, _util.assignEvent)(minusHandle, 'click', function() {
        var _this4$_state = _this4._state,
            zoomValue = _this4$_state.zoomValue;
        var newZoomValue = zoomValue - _util.ZOOM_CONSTANT;
        _this4.zoom(newZoomValue);
      });
      this._events.onZoomPlusClick = (0, _util.assignEvent)(plusHandle, 'click', function() {
        var _this4$_state = _this4._state,
            zoomValue = _this4$_state.zoomValue;
        var newZoomValue = zoomValue + _util.ZOOM_CONSTANT;
        _this4.zoom(newZoomValue);
    ...
    value: function _calculateDimensions() {
      ...
      this._state.zoomSliderLength = snapViewWidth - zoom - 34;
    }
  }, {
    key: "resetZoom",
